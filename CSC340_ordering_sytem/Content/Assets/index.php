                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-md-12 col-sm-12 col-xs-12 our-menu-tab-container">
                                ...
                                <div class="col-md-2 col-sm-3 col-xs-12 tab-menu">
                                    <div class="list-group"> <a href="#" class="list-group-item active text-center"> PIZZAS </a>
                                        <a href="#" class="list-group-item text-center"> SIDES </a>
                                        <a href="#" class="list-group-item text-center"> DESERT </a>
                                        <a href="#" class="list-group-item text-center"> DRINKS </a>
                                    </div>
                                </div>
                                <!-- Tab menu -->
                                <!-- Our Menu Tabs -->
                                <div class="col-md-10 col-sm-9 col-xs-12 our-menu-tabs">
                                    ...
                                    <div class="tab-content active">
                                        ...
                                        <div class="our-menu-slider">
                                            <!-- Item -->
                                            <div class="item"> <img class="lazyOwl" src="assets/img/menu/menu_home_1/starter_1.jpg" alt="Food menu">
                                                <!-- Item Description -->
                                                <div class="item_desc">
                                                    <h3>Pizza Name <span class="price pull-right">$28.99</span></h3>
                                                    <p>Aenean commodo ligula eget dolor enean massa. Cum sociis natoque penatibus.</p>
                                                    <div class="form-group buttons">
                                                        <a class="btn btn-gold" href="#">
                                                            <i class="fa fa-shopping-cart fa-fw"></i> Add-Item
                                                        </a>
                                                    </div>
                                                </div>
                                        ...
                                        <!-- End our menu slider -->
                                        <a href="menu_gird.html" class="view_all btn btn-gold ">View all pizzas</a> </div>
                                    <!-- End Tab content -->
                                    <!-- Tab content  -->
                                    <div class="tab-content">
                                        ...
                                        <div class="our-menu-slider">
                                            <!-- Item -->
                                            <div class="item"><img class="lazyOwl" src="assets/img/menu/menu_home_1/dishes_1.jpg" alt="Food menu">
                                                <!-- Item description -->
                                                <div class="item_desc">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="our-menu-slider">
                                            <!-- Item -->
                                            <div class="item"> <img class="lazyOwl" src="assets/img/menu/menu_home_1/desert_1.jpg" alt="Food menu">
                                                <!-- Item Description -->
                                                <div class="item_desc">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="our-menu-slider">
                                            <!-- Item -->
                                            <div class="item"> <img class="lazyOwl" src="assets/img/menu/menu_home_1/drinks_1.jpg" alt="Food menu">
                                                <!-- Item Description -->
                                                <div class="item_desc">
